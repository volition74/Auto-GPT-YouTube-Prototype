channel_info = {
    ...
    'Ben Howard': {
        'description': 'This channel focuses on my personal life, thoughts, creativity It is mainly to learn about a range of topics. I like to investigate many topics including, Science, religion, Atheism, Personal Growth, Art, Graphic Design, Video and Audio Equipment, Cinema, History and Politics. This channel is about anything that is happening in my life and my thoughts opinion and investigation',
        'tone': 'Personal',
