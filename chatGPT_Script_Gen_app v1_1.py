...
# Clean user_topic and user_minutes for use in filename
clean_user_topic = clean_filename(user_topic)
clean_user_minutes = clean_filename(user_minutes)

# Create log file using user's preferred directory and user_topic
filename = os.path.join(directory, f'{clean_user_topic}_{clean_user_minutes}minutes_chatGPT_logs.txt')
